...
with col3_esq:
     with st.expander("🏪 Preços dos Materiais no Depósito (Clique para abrir)"):
            ...
            preco_ferro_38_7x20 = st.number_input("Coluna/Viga 3/8 7x20 (R$):", value=130.0, step=2.0, key="p_f_7x14")
            preco_ferro_38_7x14 = st.number_input("Coluna/Viga 3/8 7x14 (R$):", value=130.0, step=2.0, key="p_f_7x14")
            preco_ferro_516_7x14 = st.number_input("Coluna/Viga 5/16 7x14 (R$):", value=65.0, step=2.0, key="p_f_7x14")
            preco_viga_516_7x20 = st.number_input("Coluna/Viga 5/16 7x20 (R$):", value=85.0, step=2.0, key="p_v_7x20")
