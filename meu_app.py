...
with col_f1:
    ...
    if incluir_contrapiso:
        opcao_contrapiso = st.selectbox(
            ...
            [
                "Contrapiso Padrão (4 cm)",
                "Contrapiso Reforçado (6 cm)"
            ],
            index=0,
            key="sel_contrapiso"
        )
...
if incluir_muro:
    ...
    if incluir_muro and metros_muro > 0:
        if metros_muro < 2.5:
            num_colunas_muro = 0
        elif 2.5 <= metros_muro <= 4.0:
            num_colunas_muro = 1
        else:
...
# =========================================================================
# 📘 MANUAL DO PROPRIETÁRIO / GUIA DE MONTAGEM (NO FINAL DA TELA)
# =========================================================================
st.write("---")
