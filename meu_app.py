...
with col3_esq:
    with st.expander("🏪 Preços dos Materiais no Depósito (Clique para abrir)"):
        ...
        # Divisão interna em duas colunas para dar mais espaço aos campos
        dep_col1, dep_col2 = st.columns(2)
        
        with dep_col1:
            st.markdown("**🧱 Materiais Básicos**")
            ...
            st.markdown("**🪵 Madeiras e Fixadores**")
        ...
        with dep_col2:
            st.markdown("**⛓️ Ferragens e Colunas**")
            ...
            st.markdown("**📐 Treliças e Madeirame**")
            ...
            preco_viga_madeira_15 = st.number_input("Metro da Viga 0,05x0,15 (R$):", value=35.0)
            preco_viga_madeira_12 = st.number_input("Metro da Viga 0,05x0,12 (R$):", value=30.0)
            preco_caibro = st.number_input("Metro do Caibro 0,05x0,05 (R$):", value=15.0)
